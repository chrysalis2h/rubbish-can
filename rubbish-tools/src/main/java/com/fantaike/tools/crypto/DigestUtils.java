 ...
 *   @Description: 推荐直接使用 SecureUtil
 *   @Author: FROM MDD-PC
 *   @Date: 2019\12\27 0027 15:47
 *   @Version: v1.0 文件初始创建
 */
@Deprecated
public class DigestUtils {
    ...
    public static byte[] generateSalt(int numBytes) {
        if (!(numBytes > 0)) {
            throw new IllegalArgumentException(String.format("numBytes argument must be a positive integer (1 or larger)", numBytes));
        }
