...
public class MD5 {
    ...
    /**
     * 默认password与客户代码（userid）一致则PASSWORDTYPE值为defalut，否则为DEFALTPASSWORD属性值
     */
    static final String PASSWORDTYPE = "defalut";
    /**
     * 修改PASSWORDSET和OWNPASSWORD属性来制定用何种默认密码
     * 1.PASSWORDSET为defalut password与客户代码一致
     * 2.PASSWORDSET不为defalut password为OWNPASSWORD的值
     */
    static final String PASSWORDSET = "defalut";
    static final String OWNPASSWORD = "123456";
    ...
    */
    ...
    private static long[] count = new long[2];  // number of bits, modulo 2^64 (lsb first)
...
　　　　　 字节拷贝到output的outpos位置开始
    ...
    */
    ...
    public static void main(String[] a) {
        try {
            System.out.println(MD5.code("admin123456", 16));
        } catch (Exception e) {
