...
public class RSASignUtils {
    ...
    public static String rsaSign(Object bizContent, String privateKey) throws Exception {
        ...
        //利用重载的方法生成签名
        String rsaSign = RSASignUtils.rsaSign(content.getBytes(StandardCharsets.UTF_8), privateKey);
        return rsaSign;
    }
    ...
    public static boolean verify(String bizContent, String publicKey, String sign) throws Exception {
        ...
        byte[] date = URLEncoder.encode(bizContent, "UTF-8").getBytes(StandardCharsets.UTF_8);
        //对用Base64编码的公钥进行解码
