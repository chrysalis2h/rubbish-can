...
public class SJRSAUtil {
    ...
    public  String sign(byte[] data, String privateKey) throws Exception {
        byte[] keyBytes = SJBase64Util.decode(privateKey);
        ...
        return SJBase64Util.encode(signature.sign());
    }
    ...
    public  boolean verify(byte[] data, String publicKey, String sign)
            throws Exception {
        byte[] keyBytes = SJBase64Util.decode(publicKey);
        ...
        signature.update(data);
        return signature.verify(SJBase64Util.decode(sign));
    }
    ...
    public static String getPrivateKey(Map<String, Object> keyMap)
        ...
        return SJBase64Util.encode(key.getEncoded());
    }
